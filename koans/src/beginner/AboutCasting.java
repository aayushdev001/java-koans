...
public class AboutCasting {
    ...
    public void upcastWithInheritance() {
        ...
        assertEquals(child instanceof Child, false);
        assertEquals(parentReference instanceof Child, false);
        assertEquals(parentReference instanceof Parent, false);
        assertEquals(parentReference instanceof Grandparent, false);
    }
    ...
    public void downcastWithInheritance() {
        ...
        assertEquals(childReference instanceof Child, false);
        assertEquals(childReference instanceof Parent, false);
        assertEquals(childReference instanceof Grandparent, false);
    }
